...
[Возможности](#-ключевые-возможности) • [Установка](#-установка-и-сборка) • [Архитектура](#-архитектура) • [Безопасность](#-безопасность-и-правила-faceit) • [English Version](README.md)
